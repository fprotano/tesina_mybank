...
@Entity
@Table
public class Help_center_thread {
	@Id
...
//	private Help_center help_center;
	...
	public Help_center_thread(Integer id, Timestamp created_at, Integer help_center_id, String question,
			String answer) {
		this.id = id;
		this.created_at = created_at;
		this.help_center_id = help_center_id;
